                ...
                return (
                  <div
                    ...
                    className={`rounded-2xl border transition-all duration-300 shadow-xs ${
                      isOpen
                        ? "bg-white dark:bg-brand-dark-gray/50 border-brand-cyan/80 dark:border-brand-cyan/40 shadow-sm"
                        : "bg-white/90 dark:bg-brand-dark-gray/25 border-slate-200/90 dark:border-brand-dark-gray/80 hover:border-brand-cyan/40 dark:hover:border-brand-cyan/20"
                    }`}
                  >
                    <button
                    ...
                    >
                      ...
                      <svg
                        className={`w-5 h-5 text-slate-500 dark:text-slate-400 transition-transform duration-300 ${isOpen ? "rotate-180 text-brand-cyan dark:text-brand-cyan" : ""}`}
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2.5"
                        viewBox="0 0 24 24"
